...
//constructor parametros
    ...
    public Empleado_Planilla(String text, String text0, String text1, String text2, int parseInt, String toString, int parseInt0, int parseInt1, int parseInt2, int parseInt3) {
